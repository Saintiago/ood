...
BOOST_FIXTURE_TEST_SUITE(Document, Document_)
	...
	// —охран€ет текущее состо€ние документа в файл формата html с изображени€ми
	...
	// »стори€ содержит максимум 10 комманд
